...
// ── Render: Footer ────────────────────────────────────────────────────────
  const renderFooter = () => {
    ...
    const SectionToggle = ({ open, onToggle, title, subtitle, accentColor }) => (
      <button
        onClick={onToggle}
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex gap-4 items-start">
                    ...
                    <div className="flex-grow bg-white border-2 border-purple-200 rounded-xl p-4 shadow-sm relative overflow-hidden">
                      ...
                      <div className="mt-2 grid grid-cols-2 gap-1.5">
                        <div className="flex items-center gap-1.5 text-xs text-slate-600 bg-slate-50 rounded-lg px-2 py-1">
                  ...
                  <div className="flex gap-4 items-start">
                    ...
                    <div className="flex-grow bg-white border-2 border-orange-200 rounded-xl p-4 shadow-sm relative overflow-hidden">
                      ...
                      <div className="mt-2 flex flex-wrap gap-1.5">
                        <span className="text-xs bg-slate-100 text-slate-600 px-2 py-0.5 rounded-full">error rate tracking</span>
                        <span className="text-xs bg-slate-100 text-slate-600 px-2 py-0.5 rounded-full">trend detection</span>
                        <span className="text-xs bg-slate-100 text-slate-600 px-2 py-0.5 rounded-full">L1 quality signals</span>
                        <span className="text-xs bg-slate-100 text-slate-600 px-2 py-0.5 rounded-full">anonymous cross-device ID</span>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="flex gap-4 items-start">
                    ...
                    <div className="flex-grow bg-white border-2 border-indigo-200 rounded-xl p-4 shadow-sm relative overflow-hidden">
                      ...
                      <div className="mt-2 flex flex-wrap gap-1.5">
                        <span className="text-xs bg-indigo-50 text-indigo-700 px-2 py-0.5 rounded-full border border-indigo-100">1× → basic</span>
                        <span className="text-xs bg-indigo-50 text-indigo-700 px-2 py-0.5 rounded-full border border-indigo-100">2× → detailed</span>
                        <span className="text-xs bg-indigo-50 text-indigo-700 px-2 py-0.5 rounded-full border border-indigo-100">3× → deep</span>
                      </div>
                    </div>
                  </div>
