              ...
              <div className="border border-slate-200 rounded-xl overflow-hidden shadow-sm">
                ...
                >
                  ...
                  <div className="flex items-center gap-3 flex-shrink-0 ml-4">
                    <span className={`hidden sm:inline text-xs font-bold px-2.5 py-1 rounded-full ${levelColors[bp.level] || 'bg-slate-100 text-slate-600'}`}>{bp.level}</span>
                  ...
                  <div className="p-5 border-t border-slate-100 space-y-6 bg-white animate-fade-in">
                    ...
                    <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
                      ...
                      <div className="flex flex-col items-center bg-slate-50 rounded-xl p-3 border border-slate-100">
                        ...
                        <span className={`text-xs font-bold px-2 py-0.5 rounded-full mt-1 ${levelColors[bp.level] || 'bg-slate-100 text-slate-600'}`}>{bp.level}</span>
        ...
        <div className="grid md:grid-cols-2 gap-8">
          <div className="bg-white rounded-xl shadow-md p-6 border border-slate-100 flex flex-col">
            ...
            <div className="space-y-8 flex flex-col">
              ...
              {passed ? (
                // ── PASSED: schedule + practice again ──
                <div className="bg-white rounded-xl shadow-md p-6 border border-emerald-100 flex flex-col justify-center items-center text-center space-y-4 flex-grow">
                  ...
                  {EXAM_BLUEPRINTS[examType] && (
                    <a
                      href={EXAM_BLUEPRINTS[examType].scheduleUrl}
                      target="_blank"
                ...
                <div className="bg-white rounded-xl shadow-md p-6 border border-slate-100 flex flex-col justify-center items-center text-center space-y-4 flex-grow">
                  ...
                  {EXAM_BLUEPRINTS[examType] && (
                    <a
                      href={EXAM_BLUEPRINTS[examType].blueprintUrl}
                      target="_blank"
                      rel="noopener noreferrer"
